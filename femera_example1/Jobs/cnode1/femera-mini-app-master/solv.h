...
public:
  // ====================================== ASLAN
  //   // virtual ~Solv() = default;
       virtual ~Solv()
           {
//                   std::cout << "Solve destructor called." << std::endl;
           	//delete this->part_u;
		//delete this->part_f;
		//delete this->part_r;
		//delete this->part_b;
  ...
  // Xiaoyu: add init(E,Y,iG)
  virtual int Init( Elem*, Phys*, int, int, int )=0;
...
public:
  ...
  // Xiaoyu: add init(E,Y,iG)
  int Init ( Elem*, Phys*, int, int, int ) final;
  // Xiaoyu: add init(int)
  int Init (int, int) final;
  int Init () final;
  int Iter () final;
